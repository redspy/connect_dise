...
| Digit Puzzle | 4×4 슬라이딩 퍼즐 레이스! 동일한 퍼즐을 동시에 풀고 먼저 완성하면 승리 | 2~4명 |
...
│   │   ├── host/                       #   호스트 대시보드 (진행률 실시간 표시)
│   │   └── mobile/                     #   모바일 퍼즐 플레이 화면
│   ├── spin-battle/                    # 팽이 배틀
│   │   ├── host/                       #   호스트 화면
│   │   └── mobile/                     #   모바일 컨트롤러
│   └── dice/                           # 주사위
...
| [.docs/games/digit-puzzle/digit-puzzle.md](.docs/games/digit-puzzle/digit-puzzle.md) | Digit Puzzle 게임 기획 문서 |
