  ...
  build: {
    rollupOptions: {
      input: {
        ...
        omokHost:           resolve(__dirname, 'games/omok/host/index.html'),
        omokMobile:         resolve(__dirname, 'games/omok/mobile/index.html'),
        ...
        spectrumMindHost:    resolve(__dirname, 'games/spectrum-mind/host/index.html'),
        spectrumMindMobile:  resolve(__dirname, 'games/spectrum-mind/mobile/index.html'),
        panicCockpitHost:    resolve(__dirname, 'games/panic-cockpit/host/index.html'),
        panicCockpitMobile:  resolve(__dirname, 'games/panic-cockpit/mobile/index.html'),
        herdLogicHost:       resolve(__dirname, 'games/herd-logic/host/index.html'),
